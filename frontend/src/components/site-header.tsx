	...
	return (
		<header className="w-full sticky top-3 z-40">
			<div className="mx-auto max-w-5xl px-4">
				<div className="glass rounded-2xl border border-sakura/20 shadow-anime px-5 py-3 flex items-center justify-between gap-4">
					{/* Logo 区域 */}
					<a
						href="/"
		...
		<header className="w-full sticky top-3 z-40">
			<div className="mx-auto max-w-5xl px-4">
				<div className="glass rounded-2xl border border-sakura/20 shadow-anime px-5 py-3 flex items-center justify-between gap-4">
					...
					>
						<span className="text-xl animate-bounce-gentle">🌸</span>
						<span className="font-display text-lg font-bold bg-gradient-to-r from-[#e879a0] to-[#a855f7] bg-clip-text text-transparent group-hover:opacity-80 transition-opacity">
							CForum
						</span>
					</a>
